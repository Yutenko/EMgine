// core-chunks.js – Per-Layer Chunk-Cache + Dirty-Rects
// Usage:
//   editor.use(EditorChunks);
//   editor.renderDirtyChunks(ctx); // nach applyCamera(ctx)
//   editor.markLayerChunkDirtyAt(layer, col, row); // bei Tile-Änderungen
// API:
//   getVisibleChunkRect(), redrawLayerChunk(cx,cy,layer[,full]),
//   renderDirtyChunks(ctx), markLayerChunkDirtyAt(layer,c,r), markAllLayerChunksDirty()
// Notes:
//   Rendert Chunks Offscreen; im draw() werden nur sichtbare gezeichnet.
//   Bei hoverLayer werden andere Layer gedimmt (globalAlpha=0.2). :contentReference[oaicite:33]{index=33}
